...
const Container = () => {
  ...
  const searchHandler = () => {
    ...
    const filteredArticles = articles.filter(obj => {
      return obj.Question.toLowerCase().includes(keyword.toLowerCase())
        ...
        <div className="container_parent">
          ...
          <Box display="flex"
            ...
            {pageArticles.length > 0 ?
              (<MainSection items={pageArticles}
                pageCount={pageCount}
                handlePageClick={handlePageClick} keyword={keyword} keywordChange={updateKeyword} />) :
